...
* **`withTransitions:boolean`**<br>by default, the appearance and disapperance of individual list items is shown using a short animation. If you prefer immediate display updates, just set the (optional) `withTransitions` atttribute to `false`
